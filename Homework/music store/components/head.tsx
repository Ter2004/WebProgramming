        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 text-center">
          ...
          <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-center lg:justify-between mt-12">
            <div className="text-left lg:w-1/2">
              ...
              Our music store website makes it easy to find the instruments you need! Explore guitars, keyboards, drums, and more with a **quick search** and **daily featured products**. We also offer repairs, lessons, and exclusive deals. **Visit us today** on any device!
              </p>
